...
const ProductPageContent = ({ product }) => {
  ...
  const goToNext = () => {
    let activeSlide = document.querySelector('.slide.translate-x-0');
    let activeButton = document.querySelector('.visible');
  ...
  return (
    <Layout>
      <div className='flex flex-col mt-[325px] lg:mt-0 w-[350px] md:w-[auto] lg:flex-row md:flex-col items-center justify-center'>
        <div className='relative flex items-center justify-center sm:w-[600px] w-[450px]'>
          <div onClick={goToPrevious} className="visible">
